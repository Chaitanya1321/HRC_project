...
function buildTable(data) {
    ...
    for (let i in data) {
    	...
    	let tableRowEle = `<div class="row-header">
    <div class="cell" data-title="checkbox">
        <input type="checkbox" onclick="selectAllRow(this)" style="background-color: #273D49CC;"/>
    </div>
    <div class="cell" data-title="Sl no">
       Sl no
   </div>
   <div class="cell" data-title="Business Code">
       Business Code
   </div>
   <div class="cell" data-title="Customer Number">
       Customer Number
   </div>
   <div class="cell" data-title="Customer Name">
       Customer Name
   </div>
   <div class="cell" data-title="Clear Date">
       Clear Date
   </div>
   <div class="cell" data-title="Business Year">
       Business Year
   </div>
   <div class="cell" data-title="Document Id">
       Document Id
   </div>
   <div class="cell" data-title="Posting Date">
       Posting Date
   </div>
   <div class="cell" data-title="Document Create Date">
       Document Create Date
   </div>
   <div class="cell" data-title="Document Create Date.1">
       Document Create Date.1
   </div>
   <div class="cell" data-title="Due Date">
       Due Date
   </div>
   <div class="cell" data-title="Invoice Currency">
       Invoice Currency
   </div>
   <div class="cell" data-title="Document Type">
       Document Type
   </div>
   <div class="cell" data-title="Posting Id">
       Posting Id
   </div>
   <div class="cell" data-title="Area Business">
       Area Business
   </div>
   <div class="cell" data-title="Total Open Amount">
       Total Open Amount
   </div>
   <div class="cell" data-title="Baseline Create Date">
       Baseline Create Date
   </div>
   <div class="cell" data-title="Customer Payment Terms">
       Customer Payment Terms
   </div>
   <div class="cell" data-title="Invoice Id">
       Invoice Id
   </div>
   <div class="cell" data-title="Is Open">
       Is Open
   </div>
</div>`
